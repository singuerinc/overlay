...
import { add as addColumn, remove as removeColumn } from '../../actions/columns';
    ...
    return (
      <Wrapper x={x} y={y} ref={this.el}>
        ...
        <MenuWrapper>
          ...
          >
            <MiniToolboxIcon active={isAlwaysOnTop} icon="layers" />
          </MiniToolboxItem>
          <MiniToolboxItem
          ...
          >
            <MiniToolboxIcon active={isToolsVisible} icon={isToolsVisible ? 'eye' : 'eye-off'} />
          </MiniToolboxItem>
          <ToolSpace />
          <MiniToolboxItem title="New guide" onClick={() => this.props.addGuide()}>
            <MiniToolboxIcon icon="layout" />
          </MiniToolboxItem>
          <MiniToolboxItem title="New ruler" onClick={() => this.props.addRuler()}>
            <MiniToolboxIcon icon="square" />
          </MiniToolboxItem>
          <MiniToolboxItem title="New onion image" onClick={() => this.openDialogToSelectImage()}>
...
const Toolbox = connect((store: IAppStore, ownProps) => store, {
  addColumn,
  addGrid,
  addGuide,
  addOnion,
